								...
								<div class="table-responsive">
									<table class="table table-bordered mg-b-0">
										...
										<tr> 
											...
											<td>
												<a href="email:{{$value->email}}">  {{$value->email}} </a>  
											</td>  
											<td class="actions"> 
												<a onclick="return confirm('Are you sure?')" href="/admin/newsletter-subscription/delete/{{base64_encode($value->id)}}" class="btn ripple btn-danger"> <i class="fa fa-trash-o"></i> Delete </a>
											</td>
										</tr>
										@endforeach
									</table>
