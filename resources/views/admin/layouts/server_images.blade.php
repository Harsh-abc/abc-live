						...
						<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							<div class="card-body">  
								<div class="form-group">
									<div id="dropzone">
										...
										@php
											...
											if($module_name=='blog') {$module_name = 'media';}
										@endphp
										--}}
										{{--
								...
								<div class="form-group submit">
									<a  href='{{ url()->current() }}' id="save_button" class="btn btn-sm btn-primary" disabled="disabled" > {{ __('Upload') }}</a> 
								</div>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-md-9 ServerImgScroll">
										<div class="row d-flex ServerImgList">									
											{{--
											@php
											// $pid = print("<span id='pid'></span>");
										
												use App\Http\Controllers\CommonController;
												// if ($module_name == "project" || $module_name == "blog" || $module_name == "product" || $module_name == "seo" || $module_name == "dashboard" || $module_name == "cms" || $module_name == "newsletter-subscription" || $module_name == "career" || $module_name == "inquiry") {
