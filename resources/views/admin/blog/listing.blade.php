									...
									<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered mg-b-0" id="data-table">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-center">
													@if($item->is_banner == 0) 
													<a  href="/admin/blog/bannerStatus/{{base64_encode($item->is_banner)}}/{{base64_encode($item->id)}}" class="btn btn-danger status_inactive" title="Change Status"><i class='fa fa-times'></i></a> </td>
													@else 
													<a  href="/admin/blog/bannerStatus/{{base64_encode($item->is_banner)}}/{{base64_encode($item->id)}}" class="btn btn-primary status-active" title="Change Status"><i class='fa fa-check'></i></a> </td>
													@endif
												</td>
												<td class="text-center">
													@if($item->is_popular == 0) 
													<a  href="/admin/blog/popularStatus/{{base64_encode($item->is_popular)}}/{{base64_encode($item->id)}}" class="btn btn-danger status_inactive" title="Change Status"><i class='fa fa-times'></i></a> </td>
													@else 
													<a  href="/admin/blog/popularStatus/{{base64_encode($item->is_popular)}}/{{base64_encode($item->id)}}" class="btn btn-primary status-active" title="Change Status"><i class='fa fa-check'></i></a> </td>
													@endif
												</td>
												<td class="text-center">
													@if($item->status == 0) 
