								...
								<div class="">
									<form method="POST" class="row justify-content-md-center" action="/admin/blog/blog-update" enctype="multipart/form-data" >	
										...
										<input type="hidden" name="edit_id" value="{{$blog->id}}"/>			 
											<div class="row">
												<div class="col-lg-9 col-md-9 form-group">
													...
													<input name="post_author" id="post_author"  value="{{$blog->post_author}}"  required="" class="form-control" placeholder="Blog Title..." onkeypress="ArticleNameurl();" onblur="ArticleNameurl();" type="text">
												</div>
										...
										<!--	<div class="form-group lg-editor">
											...
											<div class="form-group lg-editor">
												<textarea name="blog_content" class="form-control" cols="10" rows="2" id="new-editor" placeholder="Description...">{!! ($blog->blog_content) ? $blog->blog_content : 'NA' !!} </textarea>  
										...
										<div class="col-xl-3 col-lg-3 col-md-3">
											...
											<div class="col-lg-9 col-md-9 form-group">
													...
													<input name="Alt_Text_Thumbnail" id="Alt_Text_Thumbnail" value="{{$blog->Alt_Text_Thumbnail}}" required="" class="form-control" placeholder="Alt_Text_Banner" onkeypress="ArticleNameurl();" onblur="ArticleNameurl();" type="text">
												</div>
