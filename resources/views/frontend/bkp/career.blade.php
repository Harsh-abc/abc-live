...
<head>
    ...
    <meta name="description"
        content="Wanna work with us? Simple post your resume or fill out the information on ABC Designs." />
                ...
                <div class="container">
                    ...
                    <div class="row contact_bg">
                        <div class="col-md-12 wow fadeInDown" data-wow-delay="0.2s">
                            <div class="">
                                <p> Please fill out the information below. Alternatively, you may call or send us an
                                    email using our contact details. <br />
                                ...
                                ?>"
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 required">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                ...
                                                ?>" required="required">
                                            <span id="nameErr" class="error-message"><?php //echo $nameErr;
                                            ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 required">
                                            ...
                                            <input type="text" class="form-control" id="contact" name="contact"
                                                ...
                                                ?>"
                                                required="required">
                                            <span id="contactErr" class="error-message"><?php //echo $contactErr;
                                            ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 required">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email"
                                                ...
                                                ?>"
                                                required="required">
                                            <span id="emailErr" class="error-message"><?php //echo $emailErr;
                                            ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 required">
                                            ...
                                            <input type="text" class="form-control" id="location"
                                                name="location" placeholder="Location" value="<?php //echo $location;
                                                ?>"
                                                required="required">
                                            <span class="error-message"><?php //echo $locationErr;
                                            ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 fileUpload required">
                                            ...
                                            <label for="attachment"><img src="/img/icons/upload.png"
                                                    alt="image"><span>Attach Your CV&hellip;</span></label>
                                            <span class="error-message"><?php //echo $attachmentErr;
                                            ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12 required">
                                            ...
                                            <textarea type="textbox" class="form-control" id="message" name="message" placeholder="Message" required /> <?php //echo $message_text;
                                            ?> </textarea>
                                            <span id="messageErr" class="error-message"><?php //echo $messageErr;
                                            ?></span>
                                        </div>
                                    </div>
