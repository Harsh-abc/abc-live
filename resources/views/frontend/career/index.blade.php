                    ...
                    <div class="container-fluid g-0 pt-80 pb-80">
                        ...
                        <div class="row justify-content-center mt-4">
                            ...
                            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                                <div class="career__gallery-img img-anim"> <img src="/img/office/IMG_6559.PNG"
                                        alt="Career" data-speed="auto" /> </div>
                            </div>
                            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                                <div class="career__gallery-img"> <img src="/img/office/IMG_6560.PNG" alt="Career" />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="job__list">
                                    <a href="/career/digital-marketing-manager">
                                        <div class="job__item">
                                            ...
                                            <h4 class="job__open">(02 Open Roles)</h4>
                                            <div class="job__link"><span><i class="fa-solid fa-arrow-right"></i></span>
                                            </div>
                                        </div>
                                    </a>
