		...
		//if(seourl===work_name){
			...
			for (let i = 0; i < project_data.length; i++) {
			   ...
			   //console.log(name);
				...
				if (thumbnail==0) {
					html += `<div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4  ${type}"> <article class="blog__item"> <div class="blog__img-wrapper"> <a href="view?projects=${seourl}"> <div class="img-box"> <video id="video_thumb" autoplay loop muted> <source src="${video_thumb}.mp4" type="video/mp4"> <source src="${video_thumb}.ogg" type="video/ogg"> Your browser does not support HTML5 video. </video> </div> </a> </div> <h4 class="blog__meta"> ${category_name} </h4> <h5><a href="view?projects=${seourl}" class="blog__title"> ${name} </a></h5> </article> </div>`; 			
			   } else {
					html += `<div class="col-xxl-3 col-xl-4 col-lg-4 col-md-4  ${type}"> <article class="blog__item"> <div class="blog__img-wrapper"> <a href="view?projects=${seourl}"> <div class="img-box"> <img class="image-box__item" src="${thumbnail}" alt="${name}" onerror="this.onerror=null; this.src='/img/portfolio/no_img.jpg'" /> <img class="image-box__item" src="${thumbnail}" alt="${name}" onerror="this.onerror=null; this.src='/img/portfolio/no_img.jpg'" /> </div> </a> </div> <h4 class="blog__meta"> ${category_name} </h4> <h5><a href="view?projects=${seourl}" class="blog__title"> ${name} </a></h5> </article> </div>`;	
			   }
