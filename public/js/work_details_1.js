    ...
    success: function(response, status)  {
      ...
      //console.log(response.projects)
		...
		for (let i = 0; i < projectdata.length; i++) {
			const {title, seourl, name, banner, category_name, start_date, end_date, year, client, project_head, project_info, project_info2, work_desc, tools, project } = projectdata[i];
