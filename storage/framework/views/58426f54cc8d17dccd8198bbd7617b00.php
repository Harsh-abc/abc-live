										...
										<div class="col-xl-9 col-lg-9 col-md-9">
											...
											<div class="row">
												...
												<div class="col-lg-9 col-md-9 form-group">
													...
													<input name="post_author" id="post_author" value="" required="" class="form-control" placeholder="Blog Title..." onkeypress="ArticleNameurl();" onblur="ArticleNameurl();" type="text">
												</div>
												...
												<div class="col-lg-12 form-group"> 
													...
													<div class="input-group mb-2"> 
														<div class="input-group-prepend"> <div class="input-group-text">https://abcdesigns.in/blog/</div> </div>
											...
											<div class="form-group lg-editor">
												<label for="description">Blog Content </label>
												<textarea name="blog_content" class="form-control" cols="10" rows="2" id="new-editor" placeholder="Description..." required> </textarea>  
											</div>
											...
											<div class="form-group">
												<div class="card shade">  
													<div class="image-upload"> 
														...
														<center>
															<label for="upload"> 
															<img src="<?php echo e(url('/admin/img/no_img_xl.jpg')); ?>" id='imgid' class="text-center img-fluid" style="cursor: pointer" title="Click here to update Image" /> </label>
														</center>
												...
												<div class="col-lg-9 col-md-9 form-group">
													<label>Alt Text : <span>*</span></label>
													<input name="Alt_Text_Thumbnail" id="Alt_Text_Thumbnail" value="" required="" class="form-control" placeholder="Alt_Text_Thumbnail" onkeypress="ArticleNameurl();" onblur="ArticleNameurl();" type="text">
												</div>
											<div class="form-group">
												<div class="card shade">  
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\abcdesigns_2025\abcdesigns_2025\resources\views/admin/blog/add.blade.php ENDPATH**/ ?>