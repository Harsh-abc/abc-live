          ...
          <div class="container g-0 pt-140 pb-140">
            ...
            <div class="row">
              <div class="col-xxl-12">
                ...
                <p> At ABC Designs, we are passionate about creating exceptional digital experiences that drive success
                  for our clients. If you are looking for a dynamic and innovative work environment where you can
                  unleash your creativity, collaborate with talented professionals, and make a real impact, then you've
            ...
            <div class="row">
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                <div class="career__gallery-img"> <img src="/img/office/IMG_6555.PNG" alt="Career" /> </div>
              </div>
              <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
                <div class="career__gallery-img img-anim"> <img src="/img/office/IMG_6559.PNG" alt="Career"
                    data-speed="auto" /> </div>
              </div>
              <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3">
                <div class="career__gallery-img"> <img src="/img/office/IMG_6560.PNG" alt="Career" /> </div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="job__area pt-130 pb-150" id="job_list">
          <div class="container">
            <div class="row">
              ...
              <div class="col-xxl-12">
                <div class="job__list">
                  <a href="/career/digital-marketing-manager">
                    <div class="job__item">
                  ...
                  <a href="/career/graphic-designer">
                    <div class="job__item">
                      <p class="job__no">02</p>
                      <h3 class="job__title">Graphic Designer</h3>
                      <h4 class="job__open">(02 Open Roles)</h4>
                      <div class="job__link"><span><i class="fa-solid fa-arrow-right"></i></span></div>
                    </div>
                  </a>
...
unset($__errorArgs, $__bag); ?>" id="name"
                          name="name" placeholder="Name" value="<?php echo e(old('name')); ?>" required="required">
...
unset($__errorArgs, $__bag); ?>" id="contact"
                          name="contact" placeholder="Phone Number" value="<?php echo e(old('contact')); ?>" required="required">
...
unset($__errorArgs, $__bag); ?>" id="email"
                          name="email" placeholder="Email Address" value="<?php echo e(old('email')); ?>" required="required">
...
unset($__errorArgs, $__bag); ?>"
                          id="location" name="location" placeholder="Location" value="<?php echo e(old('location')); ?>"
                          required="required">
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="col-12 form-group required">
                        ...
                        <div class="btn_wrapper">
                          <button class="wc-btn-primary btn-hover btn-item" id="submit"><span></span> Send <br>Messages
  ...
  <script src="/js/custom-file-input.js"></script><?php /**PATH /opt/bitnami/apache/htdocs/abcdesigns_2025/resources/views/frontend/career/index.blade.php ENDPATH**/ ?>