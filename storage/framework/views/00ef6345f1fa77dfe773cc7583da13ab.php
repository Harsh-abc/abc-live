                            ...
                            <div class="card-body pt-0">
                                <div class="">
                                    <form method="POST" class="row justify-content-md-center"
                                        action="<?php echo e(route('project.store')); ?>" enctype="multipart/form-data">
                                        <div class="col-xl-9 col-lg-9 col-md-9">
                                            ...
                                            <div class="card shade">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-7 form-group">
                                                        ...
                                                        <input name="page_title" class="form-control"
                                                            placeholder="Project Title..." maxlength="255" type="text"
                                                            id="title">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="heading_1" class="form-control"
                                                        placeholder="1st Heading..." maxlength="255" type="text"
                                                        id="heading_1">
                                                </div>

                                                <div class="form-group">
                                                    <label for="BookDescription"> 1st Section Description </label>
                                                    <textarea name="description" class="form-control content" cols="10" rows="2" id="description"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="tags" type="text" data-role="tagsinput"
                                                        class="form-control"
                                                        value="Brand Development, UX/UI Design, Front-End Development,  UX/UI Design, Front-End Development, SVG Animations, Laravel Development">
                                                </div>

                                                <div class="form-group">
                                                    <label>Development Technology</label>
                                                    <select name="products[]" multiple data-role="tagsinput"
                                                        class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="heading_2" class="form-control"
                                                        placeholder="2nd Heading..." maxlength="255" type="text"
                                                        id="heading_2">
                                                </div>

                                                <div class="form-group">
                                                    <label for="description_2"> 2nd Section Description </label>
                                                    <textarea name="description_2" class="form-control content1" cols="10" rows="2" id="description_2"
                                                        placeholder="Description..."></textarea>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="file" id="files" class="form-control d-block"
                                                            name="horizontal_gallery[]" multiple />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input id="verfiles" class="form-control d-block" type="file"
                                                            name="vertical_gallery[]" multiple />
                                                    </div>
                                                    <div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/abcdesigns_2025/resources/views/admin/projects/add_details.blade.php ENDPATH**/ ?>