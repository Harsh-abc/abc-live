			...
			<div class="portfolio__detail-content">
				<div class="container g-0 pt-100">
					...
					<div class="block-content">
						...
						<div class="row" id="third_section">
							...
							<div class="col-xxl-12">
								<h3 class="portfolio__detail-title title-anim"> The Bharat Inclusion Summit is designed as a platform to reflect upon the lessons and deliberate on the way forward for inclusive fintech in India. </h3>
								 
								<p> The Initiative has had five key domains of work - evangelisation of inclusive fintech solutioning, incubation of novel innovations, acceleration of promising inclusive fintech startups, investing seed capital unlock impact at scale and research that encapsulates that entire journey from the customer to impact. In its tenure of five years, BII has delivered many firsts, all of which have been aimed at serving the low income customer and serving them better. </p> 
								<br /> <br />  
							</div>
							-->
							...
							<div class="col-xxl-8 col-xl-7 col-lg-7 col-md-7">
								<div class="portfolio__detail-text">
									<p> We formed a team together with the company carrying out several processes of ideation, research, wireframing, prototyping, and development that resulted in a product that is prepared to "communicate and explain" new types of service that must be presented in a clear and effective manner. </p>
									
									<p> We worked closely with the Inclusion Summit organizers to understand their vision, objectives, and target audience. We conducted thorough research to ensure the website design and features aligned with the event's purpose and inclusive principles. </p>
									
									<p> We designed and developed a digital product with a solid graphic system (UX/UI) and strong features of Information Hub. </p>
									
									<p> The website integrated a seamless registration system, allowing attendees to sign up for the summit, select workshops, and manage their schedules. </p>
					...
					<div class="block-gallery" id="forth_section">
						<img src="/img/portfolio/bii/6.jpg" alt="Portfolio Image"> 
						<img src="/img/portfolio/bii/5.jpg" alt="Portfolio Image"> 
					</div> 
					...
					<div class="block-img-text" id="fifth_section">
						...
						<p id="fifth_para"> For those of us who are blessed with good sight. So we seldom consider  it. That’s why going off to  investigate the whys and hows involved is a little like trying to get behind the wind </p>
					</div>
...
<script type='text/javascript' src='https://iprodev.github.io/Scrollax.js/lib/scrollax.min.js'></script>
 <?php /**PATH /opt/bitnami/apache/htdocs/abcdesigns_2025/resources/views/frontend/work/view_static.blade.php ENDPATH**/ ?>