								...
								<div class="table-responsive">
									<table class="table table-bordered mg-b-0">
										...
										<tr> 
											...
											<td>
												<a href="email:<?php echo e($value->email); ?>">  <?php echo e($value->email); ?> </a>  
											</td>  
											<td class="actions"> 
												<a onclick="return confirm('Are you sure?')" href="/admin/newsletter-subscription/delete/<?php echo e(base64_encode($value->id)); ?>" class="btn ripple btn-danger"> <i class="fa fa-trash-o"></i> Delete </a>
											</td>
										</tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/abcdesigns_2025/resources/views/admin/newsletter_subscription.blade.php ENDPATH**/ ?>