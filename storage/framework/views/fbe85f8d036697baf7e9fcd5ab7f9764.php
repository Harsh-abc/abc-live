...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group submit">
                                        <input type="submit" id="submitBtn" class="btn btn-dark w-100 submitBtn"
                                            value="Submit">
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="row justify-content-center align-items-center position-relative w-100"
                        style="z-index: 10; background-color: #121212;">
                        <div
                            class="footer__copyright text-center d-flex justify-content-center align-items-center flex-column flex-lg-row gap-3">
                            <p>
                            ...
                            <p>
                                ...
                                <a href="https://abcdesigns.in" target="_blank">ABC DESIGNS</a>
                                All Rights Reserved.
                            </p>
                        </div>
                    </div>
...
<?php /**PATH D:\wamp64\www\abcdesigns_2025\abcdesigns_2025\resources\views/frontend/layout/footer.blade.php ENDPATH**/ ?>