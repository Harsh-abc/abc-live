				...
				<div class="row pb-100">
					<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
						<div class="sec-text text-anim">
							<p> Unlock your digital potential with our comprehensive range of digital agency services, tailored to drive growth and success for your business. </p>
						</div>
					</div>
					<div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
						<div class="sec-title-wrapper">
							<h2 class=" title-anim"> Elevate Your Online Presence with Stunning Web Experiences. </h2>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="service__list-2 animation__service-2">
							<div class="service__item-2">
								<div>
									...
									<a href="/web-solutions/interactive-solutions" class="service_view"> View Details </a> 
								</div>
							</div> <!-- -->
							<div class="service__item-2">
								<div>
									...
									<a href="/web-solutions/custom-web-development" class="service_view"> View Details </a>  
								</div>
							</div> <!-- -->
							<div class="service__item-2">
								<div>
									...
									<a href="/web-solutions/ecommerce-development" class="service_view"> View Details </a> 
								</div>
							</div> <!-- --> 
...
<?php /**PATH /opt/bitnami/apache/htdocs/abcdesigns_2025/resources/views/frontend/services/index.blade.php ENDPATH**/ ?>