                ...
                <section class="blog__area-6 blog__animation blog-page-inner">
                    <div class="g-0 pb-110">
                        ...
                        <div class="row px-1 pb-50 blog-header-banner"
                            style="background-image: url('<?php echo e(!empty($blog->banner_image) ? asset($blog->banner_image) : 'https://moz.com/images/blog/banners/04-local-seo-blog-banner-BGs/local-seo-category-blog-banner-BGs-E.png?w=1920&auto=compress%2Cformat&fit=crop&dm=1757708764&s=eaab989823d1473e80127bcf56a0b06f'); ?>');">
                            <div class="col-lg-7 col-md-12"> 
							<?php
        $category = \App\Models\Categories::find($blog->category_id);
    ?>
                                <h3 class="text-capitalize" style="color: <?php echo e($blog->highlight_color ?? '#ffc107'); ?>"><?php echo e($category->name); ?></h3>
                                <h1 class="text-white"><?php echo e($blog->blog_title); ?></h1>
                                <div class="py-2 d-flex gap-4 mt-3">
                                    <div class="text-white">
                                        ...
                                        <span class="ms-2"><?php echo e(\Carbon\Carbon::parse($blog->publish_date)->format('M d, Y')); ?></span>
                                    ...
                                    <div class="text-white">
                                        ...
                                        <span class="ms-2"><?php echo e($blog->time_to_read); ?> min read</span>
                                    </div>
                                </div>
                                <div class="mt-3 d-flex align-items-center">
                                    ...
                                    <span class="text-white">Written by: <span style="color: <?php echo e($blog->highlight_color ?? '#ffc107'); ?>"><?php echo e($blog->post_author); ?></span></span>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12 mt-4 mt-lg-0">
                                <figure class="mb-0">
                                    <img src="<?php echo e(asset($blog->banner_image_1 ?? 'https://moz.com/images/blog/insets/Local-SEO.png?w=1360&h=900&auto=compress%2Cformat&fit=crop&dm=1757710396&s=8a42f69376c6267d1cc2c65929cb88b1')); ?>"
                 alt="<?php echo e($blog->alt_text_banner_1 ?? $blog->blog_title); ?>"
...
<div class="row reset-grid blog_listing">
                             ...
                             <?php $__currentLoopData = $relatedBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rBlog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
                                    <article class="blog__item">
                                        <div class="blog__img-wrapper">
                                            <a href="<?php echo e(url('/blog/' . $rBlog->blog_url)); ?>">
                                                <div class="img-box">
                                                    <img class="image-box__item" src="<?php echo e(asset($rBlog->thumb_image)); ?>"
                                                        alt="<?php echo e($rBlog->blog_title); ?>" />
                                                    <img class="image-box__item" src="<?php echo e(asset($rBlog->thumb_image)); ?>"
                                                        alt="<?php echo e($rBlog->blog_title); ?>" />
                                                </div>
                                            </a>
    ...
    ?>
                                        <h4 class="blog__meta">
                                            <a href="<?php echo e(url('/blog/' . $rBlog->blog_url)); ?>">
                                                ...
                                                <?php echo e($rBlog->post_author ?? ''); ?>

                                            </a>
                                            . <?php echo e(\Carbon\Carbon::parse($rBlog->created_at)->format('d M Y')); ?>

                                        </h4>
                                        <h5>
                                            <a href="<?php echo e(url('/blog/' . $rBlog->blog_url)); ?>" class="blog__title">
                                                <?php echo e($rBlog->blog_title); ?>

                                            </a>
                                        </h5>
                                        <p>
                                            <?php echo e(Str::limit(strip_tags($rBlog->blog_content), 250, '...')); ?>


                                        </p>

                                        <div class="mt-3">
                                            <a href="<?php echo e(url('/blog/' . $rBlog->blog_url)); ?>" class="blog__btn border rounded-pill cus-url-btn float-end me-4">
...
</body><?php /**PATH D:\wamp64\www\abcdesigns_2025\abcdesigns_2025\resources\views/frontend/blog/blog-inner.blade.php ENDPATH**/ ?>