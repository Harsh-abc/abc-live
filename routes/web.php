...
/* Landing Pages */
Route::get('/digital-marketing-services-in-india', [LandingController::class, 'indiaLandingPage']);
Route::get('/digital-marketing-services-in-uae', [LandingController::class, 'uaeLandingPage']);
Route::post('/landing-enquiry/store', [LandingController::class, 'store'])->name('landing.enquiry.store');
Route::delete('/admin/landing-enquiry/{id}', [LandingController::class, 'delete'])->name('landing.enquiry.delete');


Route::get('/admin/landing_enquiries_list', [LandingController::class, 'landing_enquiries_list']);
...
Route::get('/app-design-and-development', function () {
    return view('frontend.services.app_design_and_development');
});
Route::get('/ui-ux-design', function () {
    return view('frontend.services.ui_ux_design');
});
Route::get('/digital-marketing-services', function () {
    return view('frontend.services.digital_marketing_services');
});
Route::get('/branding-and-creative-design', function () {
    return view('frontend.services.branding_and_creative_design');
});
